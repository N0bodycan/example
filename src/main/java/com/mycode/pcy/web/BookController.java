package com.mycode.pcy.web;

import com.mycode.pcy.dto.AppointExecution;
import com.mycode.pcy.dto.Result;
...
public class BookController {
    ...
    @RequestMapping(value = {"/{bookId}/detail","/detail"}, method = RequestMethod.GET)
    private String detail(@PathVariable(value = "bookId",required = false) Long bookId, Model model) {
        if (bookId == null) {
